...
<div class="row">
    <h3 class="text-center p-4">Produk Kami Kategori Olahraga</h3>
    <?php foreach($produk as $key => $produkItem){?>
        <?php if($produkItem['kategori'] == 'olahraga'): ?>
            <div class="card" style="width: 16rem; margin: 10px 10px;">
                <img src="../img/olahraga/<?= $produkItem['gambar']; ?>" class="card-img-top" alt="..." width="100px">
                <div class="card-body">
